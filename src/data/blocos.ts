  ...
  },
  {
    ...
    floors: [
      ...
      },
      {
        ...
        rooms: [
          { code: 'B07', name: 'Salas de aula 1' },
          { code: 'B08', name: 'Salas de aula 2' },
          { code: 'B09', name: 'Salas de aula 3' },
          { code: 'B10', name: 'Salas de aula 4' },
          { code: 'B11', name: 'Salas de aula 5' },
          { code: 'B12', name: 'Salas de aula 6' },
          { code: 'B13', name: 'Salas de aula 7' },
    ...
    floors: [
      {
        ...
        rooms: [
          ...
          { code: 'F04', name: 'Laboratório de Robótica' },
          { code: 'F05', name: 'MOREA' },
